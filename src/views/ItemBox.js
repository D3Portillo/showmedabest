    ...
    render(){
        return(
            <div style={styles.box} className="itemBox">
               <h1 onClick={_=>this.props.showModal(this.props.name, this.props.artist, this.props.cover, this.props.href, this.props.albumId, this.props.price)} className="subtitle is-size-4-mobile is-size-3-tablet has-text-grey has-text-weight-normal" style={styles.boxTitle}>
