...
class LeftPane extends Component{
    ...
    render(){
        ...
        <div className={"column has-background-black is-5 searchPane " + (this.props.active ? "active" : "")} style={{...styles.pane,...styles.fadeIn}}>
            ...
            {this.state.modalIsActive ? <Modal active={this.state.modalIsActive} albumId={this.state.albumId} showTracks={this.showTracks} showingTracks={this.state.showingTracks} title={this.state.title} cover={this.state.cover} price={this.state.price} href={this.state.href} hideModal={this.hideModal}/> : ""}
        </div>
        )
    }
}
